function [face_psi1re,face_psi1im,face_psi2re,face_psi2im]=isometry_spinor_from_immersion(length,face_number,vertex_theta,vertex_src,vertex_dst,vertex_next,face_hedge,points,faces,face_psi1re,face_psi1im,face_psi2re,face_psi2im)
